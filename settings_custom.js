...
DR = {
	TipMsg: [
		"Next -> ", "注(近x2)", "电(分散)", "炸(净化)", "注(远x2)", "电(集中)", "炸(加血)",
...
HH = {
	...
	3000: {
		...
		// 503 龙炎吐息(后方入口封锁)
		//////////////////////////////
		111: {tip: [`左黑 | 右红`, `左红 | 右黑`]} // 更新debuff
	},
	TipMsg: [
		"属|性|墙",
		
		`<font color="#FF6A00">→ 火墙·右 →</font>`, // 3001 3005 右
		`<font color="#FF6A00">← 火墙·左 ←</font>`, // 3002 3006 左
		`<font color="#FF6A00">↓ 火墙·下 ↓</font>`, // 3105 3107 后
		`<font color="#FF6A00">↑ 火墙·上 ↑</font>`, // 3106 3108 前
		
		`<font color="#FF0000">红球</font>`, // 3016 3020
		`<font color="#000000">黑球</font>`, // 3017 3021
	]
},
DF = {
	46704: {
